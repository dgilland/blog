...
BLOG_AUTHOR = "Derrick Gilland"  # (translatable)
BLOG_TITLE = "Derrick Gilland"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://derrickgilland.com/"
...
FAVICONS = {
    ...
    ("icon", "/assets/img/favicon-160x160.png", "160x160"),
    ("icon", "/assets/img/favicon-192x192.png", "192x192"),
}
...
CONTENT_FOOTER = '<a href="mailto:{email}">{author}</a> - Blog powered by <a href="http://getnikola.com" rel="nofollow">Nikola</a> {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "derrickgilland"
